 ...
 */
public class HotNews extends Group {

    public static final String rss = "http://www.24h.com.vn/upload/rss/tintuctrongngay.rss";
    public static final String KEY = Source._24H.name() + Category.TIN_NONG.name();
