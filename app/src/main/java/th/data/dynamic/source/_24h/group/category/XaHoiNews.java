...
public class XaHoiNews extends th.data.dynamic.source._24h.group.Group {


    public static final String rss = "http://www.24h.com.vn/upload/rss/suckhoedoisong.rss";
    public static final String KEY = Source._24H.name() + Category.XA_HOI.name();
